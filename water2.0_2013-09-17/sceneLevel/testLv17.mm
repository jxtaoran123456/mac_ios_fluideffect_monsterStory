...
{
    //awakePraticles(20,b2Vec2(560+483,360+194),20,10.f,b2Vec2(0.f,-10.f),0.f,0,false);
...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.9f,0.002f,60.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640+253.0f-50.f) / PTM_RATIO, (360+222.0f) / PTM_RATIO);
    verts[1].Set((640+559.0f-50.f) / PTM_RATIO, (360+220.0f) / PTM_RATIO);
    verts[2].Set((640+544.0f-50.f) / PTM_RATIO, (360+197.0f) / PTM_RATIO);
    verts[3].Set((640+266.0f-20.f) / PTM_RATIO, (360+195.0f) / PTM_RATIO);
    verts[4].Set((640+283.0f-20.f) / PTM_RATIO, (360+114.0f) / PTM_RATIO);
    verts[5].Set((640+546.0f-50.f) / PTM_RATIO, (360+38.0f) / PTM_RATIO);
    verts[6].Set((640+534.0f-50.f) / PTM_RATIO, (360+36.0f) / PTM_RATIO);
    verts[7].Set((640+288.0f-50.f) / PTM_RATIO, (360+68.0f) / PTM_RATIO);
    verts[8].Set((640+318.0f-50.f) / PTM_RATIO, (360-353.0f) / PTM_RATIO);
    verts[9].Set((640+267.0f-50.f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
...
//    singleVers[2].vec2.Set((587.0f+640.f) / PTM_RATIO, (360.f+30.0f) / PTM_RATIO);
    ...
    singleVers[0].vec1.Set((640.f-633.0f) / PTM_RATIO, (360.f-355.0f) / PTM_RATIO);
    singleVers[0].vec2.Set((640.f-309.0f) / PTM_RATIO, (360.f+105.0f) / PTM_RATIO);
    
    singleVers[1].vec1.Set((640.f-309.0f) / PTM_RATIO, (360.f+105.0f) / PTM_RATIO);
    singleVers[1].vec2.Set((640.f-18.0f) / PTM_RATIO, (360.f-355.0f) / PTM_RATIO);
    
    singleVers[2].vec1.Set((640.f-18.0f) / PTM_RATIO, (360.f-355.0f) / PTM_RATIO);
    singleVers[2].vec2.Set((640.f-633.0f) / PTM_RATIO, (360.f-355.0f) / PTM_RATIO);
    
    singleVers[3].vec1.Set((640.f-18.0f) / PTM_RATIO, (360.f-355.0f) / PTM_RATIO);
    singleVers[3].vec2.Set((640.f+267.0f) / PTM_RATIO, (360.f-356.0f) / PTM_RATIO);
    
//    singleVers[4].vec1.Set((640+546.0f-50.f) / PTM_RATIO, (360+38.0f) / PTM_RATIO);
//    singleVers[4].vec2.Set((640+546.0f) / PTM_RATIO, (360+148.0f) / PTM_RATIO);
