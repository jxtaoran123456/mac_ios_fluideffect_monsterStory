...
//    [self addSingleMap];
    ...
    // Particles
    initFluidPraticles(0.9f,0.008f,250.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
-(void)addMap
{
    ...
    verts[0].Set((640.f-634.3f) / PTM_RATIO, (360.f-354.3f) / PTM_RATIO);
    verts[1].Set((640.f-632.9f) / PTM_RATIO, (360.f-183.1f) / PTM_RATIO);
    verts[2].Set((640.f-248.2f) / PTM_RATIO, (360.f-183.1f) / PTM_RATIO);
    verts[3].Set((640.f-246.8f) / PTM_RATIO, (360.f-46.0f) / PTM_RATIO);
    verts[4].Set((640.f+202.9f) / PTM_RATIO, (360.f-38.9f) / PTM_RATIO);
    verts[5].Set((640.f+202.9f) / PTM_RATIO, (360.f+106.8f) / PTM_RATIO);
    
    verts[6].Set((640.f+610.9f) / PTM_RATIO, (360.f+106.8f) / PTM_RATIO);
    verts[7].Set((640.f+610.9f) / PTM_RATIO, (360.f+760.8f) / PTM_RATIO);
    verts[8].Set((640.f+634.3f) / PTM_RATIO, (360.f+760.8f) / PTM_RATIO);
    

    verts[9].Set((640.f+631.4f) / PTM_RATIO, (360.f-352.8f) / PTM_RATIO);
