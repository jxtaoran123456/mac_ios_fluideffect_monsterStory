...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.8f,0.008f,60.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    bodyDef.position.Set((740-0.0f) / PTM_RATIO, (310+275.0f) / PTM_RATIO);
//    bodyDef.angle = 0.f;
...
//    verts[0].Set((640-638.0f) / PTM_RATIO, (360+60.0f) / PTM_RATIO);
//    verts[1].Set((640-574.0f) / PTM_RATIO, (360+6.0f) / PTM_RATIO);
//    verts[2].Set((640-569.0f) / PTM_RATIO, (360-186.0f) / PTM_RATIO);
//    verts[3].Set((640-531.0f) / PTM_RATIO, (360-242.0f) / PTM_RATIO);
//    verts[4].Set((640+32.0f) / PTM_RATIO, (360-245.0f) / PTM_RATIO);
//    verts[5].Set((640+8.0f) / PTM_RATIO, (360+97.0f) / PTM_RATIO);
//    verts[6].Set((640+120.0f) / PTM_RATIO, (360+97.0f) / PTM_RATIO);
//    verts[7].Set((640+150.0f) / PTM_RATIO, (360-246.0f) / PTM_RATIO);
//    verts[8].Set((640+469.0f) / PTM_RATIO, (360-236.0f) / PTM_RATIO);
//    verts[9].Set((640+419.0f) / PTM_RATIO, (360+105.0f) / PTM_RATIO);
//    verts[10].Set((640+568.0f) / PTM_RATIO, (360+102.0f) / PTM_RATIO);
//    verts[11].Set((640+622.0f) / PTM_RATIO, (360-339.0f) / PTM_RATIO);
//    verts[12].Set((640-631.0f) / PTM_RATIO, (360-350.0f) / PTM_RATIO);
    
//    verts[0].Set((640-627.0f) / PTM_RATIO, (360+35.0f) / PTM_RATIO);
//    verts[1].Set((640-504.0f) / PTM_RATIO, (360-5.0f) / PTM_RATIO);
//    verts[2].Set((640-514.0f) / PTM_RATIO, (360-168.0f) / PTM_RATIO);
//    verts[3].Set((640-494.0f) / PTM_RATIO, (360-268.0f) / PTM_RATIO);
//    verts[4].Set((640-146.0f) / PTM_RATIO, (360-272.0f) / PTM_RATIO);
//    verts[5].Set((640-159.0f) / PTM_RATIO, (360-3.0f) / PTM_RATIO);
//    verts[6].Set((640-25.0f) / PTM_RATIO, (360+33.0f) / PTM_RATIO);
//    verts[7].Set((640-25.0f) / PTM_RATIO, (360+108.0f) / PTM_RATIO);
//    verts[8].Set((640+76.0f) / PTM_RATIO, (360+103.0f) / PTM_RATIO);
//    verts[9].Set((640+67.0f) / PTM_RATIO, (360+30.0f) / PTM_RATIO);
//    verts[10].Set((640+101.0f) / PTM_RATIO, (360-55.0f) / PTM_RATIO);
//    verts[11].Set((640+117.0f) / PTM_RATIO, (360-203.0f) / PTM_RATIO);
//    verts[12].Set((640+136.0f) / PTM_RATIO, (360-279.0f) / PTM_RATIO);
//    verts[13].Set((640+327.0f) / PTM_RATIO, (360-273.0f) / PTM_RATIO);
//    verts[14].Set((640+307.0f) / PTM_RATIO, (360+12.0f) / PTM_RATIO);
//    verts[15].Set((640+317.0f) / PTM_RATIO, (360+84.0f) / PTM_RATIO);
//    verts[16].Set((640+381.0f) / PTM_RATIO, (360+68.0f) / PTM_RATIO);
//    verts[17].Set((640+406.0f) / PTM_RATIO, (360-351.0f) / PTM_RATIO);
//    verts[18].Set((640-634.0f) / PTM_RATIO, (360-353.0f) / PTM_RATIO);
    
    verts[0].Set((640-486.0f) / PTM_RATIO, (360+24.0f) / PTM_RATIO);
    verts[1].Set((640-410.0f) / PTM_RATIO, (360-20.0f) / PTM_RATIO);
    verts[2].Set((640-399.0f) / PTM_RATIO, (360-123.0f) / PTM_RATIO);
    verts[3].Set((640-211.0f) / PTM_RATIO, (360-117.0f) / PTM_RATIO);
    verts[4].Set((640-163.0f) / PTM_RATIO, (360-15.0f) / PTM_RATIO);
    verts[5].Set((640-150.0f) / PTM_RATIO, (360+51.0f) / PTM_RATIO);
    verts[6].Set((640-122.0f) / PTM_RATIO, (360+101.0f) / PTM_RATIO);
    verts[7].Set((640-87.0f) / PTM_RATIO, (360+97.0f) / PTM_RATIO);
    verts[8].Set((640-69.0f) / PTM_RATIO, (360-47.0f) / PTM_RATIO);
    verts[9].Set((640-57.0f) / PTM_RATIO, (360-131.0f) / PTM_RATIO);
    verts[10].Set((640+141.0f) / PTM_RATIO, (360-130.0f) / PTM_RATIO);
    verts[11].Set((640+141.0f) / PTM_RATIO, (360+102.0f) / PTM_RATIO);
    verts[12].Set((640+252.0f) / PTM_RATIO, (360+86.0f) / PTM_RATIO);
    verts[13].Set((640+264.0f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
    verts[14].Set((640-521.0f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
