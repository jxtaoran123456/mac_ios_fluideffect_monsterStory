...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.8f,0.006f,100.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
-(void)addMap
{
    ...
    verts[0].Set((640.f+147.8f) / PTM_RATIO, (360.f+282.1f) / PTM_RATIO);
    verts[1].Set((640.f+142.1f) / PTM_RATIO, (360.f-68.6f) / PTM_RATIO);
    verts[2].Set((640.f-95.5f) / PTM_RATIO, (360.f+214.3f) / PTM_RATIO);
    verts[3].Set((640.f-201.5f) / PTM_RATIO, (360.f+222.7f) / PTM_RATIO);
    verts[4].Set((640.f-194.5f) / PTM_RATIO, (360.f-130.8f) / PTM_RATIO);
    verts[5].Set((640.f-345.8f) / PTM_RATIO, (360.f-140.7f) / PTM_RATIO);
    verts[6].Set((640.f-352.8f) / PTM_RATIO, (360.f-326.0f) / PTM_RATIO);
    verts[7].Set((640.f-19.1f) / PTM_RATIO, (360.f-320.3f) / PTM_RATIO);
    verts[8].Set((640.f-21.9f) / PTM_RATIO, (360.f-136.5f) / PTM_RATIO);
    verts[9].Set((640.f-130.8f) / PTM_RATIO, (360.f-123.7f) / PTM_RATIO);
    verts[10].Set((640.f-111.0f) / PTM_RATIO, (360.f+116.7f) / PTM_RATIO);
    verts[11].Set((640.f+95.5f) / PTM_RATIO, (360.f-113.8f) / PTM_RATIO);
    verts[12].Set((640.f+205.8f) / PTM_RATIO, (360.f-118.1f) / PTM_RATIO);
    verts[13].Set((640.f+205.8f) / PTM_RATIO, (360.f+238.3f) / PTM_RATIO);
    verts[14].Set((640.f+297.7f) / PTM_RATIO, (360.f+218.5f) / PTM_RATIO);
    verts[15].Set((640.f+340.1f) / PTM_RATIO, (360.f+91.2f) / PTM_RATIO);
    verts[16].Set((640.f+313.2f) / PTM_RATIO, (360.f+79.9f) / PTM_RATIO);
    verts[17].Set((640.f+277.9f) / PTM_RATIO, (360.f+187.4f) / PTM_RATIO);
    verts[18].Set((640.f+232.6f) / PTM_RATIO, (360.f+187.4f) / PTM_RATIO);
    verts[19].Set((640.f+248.2f) / PTM_RATIO, (360.f-173.2f) / PTM_RATIO);
    verts[20].Set((640.f+102.5f) / PTM_RATIO, (360.f-180.3f) / PTM_RATIO);
    verts[21].Set((640.f-77.1f) / PTM_RATIO, (360.f+21.9f) / PTM_RATIO);
    verts[22].Set((640.f-102.5f) / PTM_RATIO, (360.f-95.5f) / PTM_RATIO);
    verts[23].Set((640.f+3.5f) / PTM_RATIO, (360.f-120.9f) / PTM_RATIO);
    verts[24].Set((640.f+16.3f) / PTM_RATIO, (360.f-338.7f) / PTM_RATIO);
    verts[25].Set((640.f-378.3f) / PTM_RATIO, (360.f-352.8f) / PTM_RATIO);
    verts[26].Set((640.f-391.0f) / PTM_RATIO, (360.f-132.2f) / PTM_RATIO);
    verts[27].Set((640.f-248.2f) / PTM_RATIO, (360.f-91.2f) / PTM_RATIO);
    verts[28].Set((640.f-234.1f) / PTM_RATIO, (360.f+270.8f) / PTM_RATIO);
    verts[29].Set((640.f-37.5f) / PTM_RATIO, (360.f+252.4f) / PTM_RATIO);
    verts[30].Set((640.f+70.0f) / PTM_RATIO, (360.f+96.9f) / PTM_RATIO);
    verts[31].Set((640.f+72.8f) / PTM_RATIO, (360.f+289.2f) / PTM_RATIO);
