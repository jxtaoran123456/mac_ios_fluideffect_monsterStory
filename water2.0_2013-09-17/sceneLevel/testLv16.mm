...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-617.3f) / PTM_RATIO, (360+279.3f) / PTM_RATIO);
    verts[1].Set((640-449.0f) / PTM_RATIO, (360+194.5f) / PTM_RATIO);
    verts[2].Set((640-514.1f) / PTM_RATIO, (360+89.8f) / PTM_RATIO);
    verts[3].Set((640-426.4f) / PTM_RATIO, (360-47.4f) / PTM_RATIO);
    verts[4].Set((640-409.4f) / PTM_RATIO, (360-194.5f) / PTM_RATIO);
    verts[5].Set((640-123.7f) / PTM_RATIO, (360-184.6f) / PTM_RATIO);
    verts[6].Set((640-140.7f) / PTM_RATIO, (360-12.0f) / PTM_RATIO);
    verts[7].Set((640-142.1f) / PTM_RATIO, (360+153.4f) / PTM_RATIO);
    verts[8].Set((640-36.1f) / PTM_RATIO, (360+159.1f) / PTM_RATIO);
    verts[9].Set((640+92.6f) / PTM_RATIO, (360+92.6f) / PTM_RATIO);
    verts[10].Set((640+29.0f) / PTM_RATIO, (360+2.1f) / PTM_RATIO);
    verts[11].Set((640-94.0f) / PTM_RATIO, (360-44.5f) / PTM_RATIO);
    verts[12].Set((640-78.5f) / PTM_RATIO, (360-194.5f) / PTM_RATIO);
    verts[13].Set((640+221.3f) / PTM_RATIO, (360-85.6f) / PTM_RATIO);
    verts[14].Set((640+358.5f) / PTM_RATIO, (360-34.6f) / PTM_RATIO);
    verts[15].Set((640+525.4f) / PTM_RATIO, (360-88.4f) / PTM_RATIO);
    verts[16].Set((640+536.7f) / PTM_RATIO,(360-218.5f) / PTM_RATIO);
    verts[17].Set((640+556.5f) / PTM_RATIO, (360-333.0f) / PTM_RATIO);
    verts[18].Set((640-627.2f) / PTM_RATIO, (360-351.4f) / PTM_RATIO);
