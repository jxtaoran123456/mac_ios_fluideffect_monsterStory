...
-(void)addMap
{
    ...
    verts[0].Set((640-459.0f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
    verts[1].Set((640-426.0f) / PTM_RATIO, (360-293.0f) / PTM_RATIO);
    verts[2].Set((640-405.0f) / PTM_RATIO, (360-197.0f) / PTM_RATIO);
    verts[3].Set((640-399.0f) / PTM_RATIO, (360-131.0f) / PTM_RATIO);
    verts[4].Set((640-373.0f) / PTM_RATIO, (360-19.0f) / PTM_RATIO);
    verts[5].Set((640-366.0f) / PTM_RATIO, (360+70.0f) / PTM_RATIO);
    verts[6].Set((640-318.0f) / PTM_RATIO, (360+162.0f) / PTM_RATIO);
    verts[7].Set((640-158.0f) / PTM_RATIO, (360+228.0f) / PTM_RATIO);
    verts[8].Set((640+44.0f) / PTM_RATIO, (360+247.0f) / PTM_RATIO);
    verts[9].Set((640+197.0f) / PTM_RATIO, (360+229.0f) / PTM_RATIO);
    verts[10].Set((640+306.0f) / PTM_RATIO, (360+135.0f) / PTM_RATIO);
    verts[11].Set((640+298.0f) / PTM_RATIO, (360-8.0f) / PTM_RATIO);
    verts[12].Set((640+78.0f) / PTM_RATIO, (360-22.0f) / PTM_RATIO);
    verts[13].Set((640+11.0f) / PTM_RATIO, (360+24.0f) / PTM_RATIO);
    verts[14].Set((640-99.0f) / PTM_RATIO, (360+37.0f) / PTM_RATIO);
    verts[15].Set((640-127.0f) / PTM_RATIO, (360-65.0f) / PTM_RATIO);
    verts[16].Set((640-108.0f) / PTM_RATIO, (360-122.0f) / PTM_RATIO);
    verts[17].Set((640-4.0f) / PTM_RATIO, (360-132.0f) / PTM_RATIO);
    verts[18].Set((640+137.0f) / PTM_RATIO, (360-113.0f) / PTM_RATIO);
    verts[19].Set((640+260.0f) / PTM_RATIO, (360-104.0f) / PTM_RATIO);
    verts[20].Set((640+258.0f) / PTM_RATIO, (360-158.0f) / PTM_RATIO);
    verts[21].Set((640+168.0f) / PTM_RATIO, (360-205.0f) / PTM_RATIO);
    verts[22].Set((640+147.0f) / PTM_RATIO, (360-290.0f) / PTM_RATIO);
    verts[23].Set((640+160.0f) / PTM_RATIO, (360-357.0f) / PTM_RATIO);
