...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.8f,0.002f,80.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-568.0f) / PTM_RATIO, (360-334.0f) / PTM_RATIO);
    verts[1].Set((640-439.0f) / PTM_RATIO, (360-168.0f) / PTM_RATIO);
    verts[2].Set((640-311.0f) / PTM_RATIO, (360-163.0f) / PTM_RATIO);
    verts[3].Set((640-215.0f) / PTM_RATIO, (360-13.0f) / PTM_RATIO);
    verts[4].Set((640-90.0f) / PTM_RATIO, (360-8.0f) / PTM_RATIO);
    verts[5].Set((640+2.0f) / PTM_RATIO, (360+144.0f) / PTM_RATIO);
    verts[6].Set((640+179.0f) / PTM_RATIO, (360+138.0f) / PTM_RATIO);
    verts[7].Set((640+240.0f) / PTM_RATIO, (360-170.0f) / PTM_RATIO);
    verts[8].Set((640+198.0f) / PTM_RATIO, (360-169.0f) / PTM_RATIO);
    verts[9].Set((640+158.0f) / PTM_RATIO, (360+95.0f) / PTM_RATIO);
    verts[10].Set((640+26.0f) / PTM_RATIO, (360+102.0f) / PTM_RATIO);
    verts[11].Set((640-49.0f) / PTM_RATIO, (360-50.0f) / PTM_RATIO);
    verts[12].Set((640-184.0f) / PTM_RATIO, (360-54.0f) / PTM_RATIO);
    verts[13].Set((640-255.0f) / PTM_RATIO, (360-198.0f) / PTM_RATIO);
    verts[14].Set((640-426.0f) / PTM_RATIO, (360-204.0f) / PTM_RATIO);
    verts[15].Set((640-495.0f) / PTM_RATIO, (360-313.0f) / PTM_RATIO);
    verts[16].Set((640+208.0f) / PTM_RATIO, (360-304.0f) / PTM_RATIO);
    verts[17].Set((640+202.0f) / PTM_RATIO, (360-239.0f) / PTM_RATIO);
    verts[18].Set((640+257.0f) / PTM_RATIO, (360-239.0f) / PTM_RATIO);
    verts[19].Set((640+285.0f) / PTM_RATIO, (360-347.0f) / PTM_RATIO);
