...
-(void)addSingleMap
{
    ...
    singleVers[0].vec1.Set((640.f-67.0f) / PTM_RATIO, (360.f-354.0f) / PTM_RATIO);
    singleVers[0].vec2.Set((640.f-51.0f) / PTM_RATIO, (360.f-240.0f) / PTM_RATIO);
    
    singleVers[1].vec1.Set((640.f-51.0f) / PTM_RATIO, (360.f-240.0f) / PTM_RATIO);
    singleVers[1].vec2.Set((640.f+16.0f) / PTM_RATIO, (360.f-235.0f) / PTM_RATIO);
    
    singleVers[2].vec1.Set((640.f+16.0f) / PTM_RATIO, (360.f-235.0f) / PTM_RATIO);
    singleVers[2].vec2.Set((587.0f+140.0f) / PTM_RATIO, (360.f+186.0f) / PTM_RATIO);
    
    singleVers[3].vec1.Set((640.f+160.0f) / PTM_RATIO, (360.f+186.0f) / PTM_RATIO);
    singleVers[3].vec2.Set((640.f+241.0f) / PTM_RATIO, (360.f-235.0f) / PTM_RATIO);
    
    singleVers[4].vec1.Set((640.f+241.0f) / PTM_RATIO, (360.f-235.0f) / PTM_RATIO);
    singleVers[4].vec2.Set((640.f+306.0f) / PTM_RATIO, (360.f-240.0f) / PTM_RATIO);
    
    singleVers[5].vec1.Set((640.f+306.0f) / PTM_RATIO, (360.f-240.0f) / PTM_RATIO);
    singleVers[5].vec2.Set((640.f+338.0f) / PTM_RATIO, (360.f-354.0f) / PTM_RATIO);
    
    singleVers[6].vec1.Set((640.f-67.0f) / PTM_RATIO, (360.f-354.0f) / PTM_RATIO);
    singleVers[6].vec2.Set((640.f+338.0f) / PTM_RATIO, (360.f-354.0f) / PTM_RATIO);
