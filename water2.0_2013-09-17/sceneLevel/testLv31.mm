...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-587.0f) / PTM_RATIO, (360-28.0f) / PTM_RATIO);
    verts[1].Set((640-457.0f) / PTM_RATIO, (360+23.0f) / PTM_RATIO);
    verts[2].Set((640-341.0f) / PTM_RATIO, (360-106.0f) / PTM_RATIO);
    verts[3].Set((640-438.0f) / PTM_RATIO, (360-172.0f) / PTM_RATIO);
    verts[4].Set((640-414.0f) / PTM_RATIO, (360-258.0f) / PTM_RATIO);
    verts[5].Set((640-303.0f) / PTM_RATIO, (360-312.0f) / PTM_RATIO);
    verts[6].Set((640-125.0f) / PTM_RATIO, (360-288.0f) / PTM_RATIO);
    verts[7].Set((640-114.0f) / PTM_RATIO, (360-89.0f) / PTM_RATIO);
    verts[8].Set((640-157.0f) / PTM_RATIO, (360-7.0f) / PTM_RATIO);
    verts[9].Set((640+20.0f) / PTM_RATIO, (360+15.0f) / PTM_RATIO);
    verts[10].Set((640+85.0f) / PTM_RATIO, (360-128.0f) / PTM_RATIO);
    verts[11].Set((640+50.0f) / PTM_RATIO, (360-283.0f) / PTM_RATIO);
    verts[12].Set((640+227.0f) / PTM_RATIO, (360-220.0f) / PTM_RATIO);
    verts[13].Set((640+351.0f) / PTM_RATIO, (360-274.0f) / PTM_RATIO);
    verts[14].Set((640+298.0f) / PTM_RATIO, (360-357.0f) / PTM_RATIO);
    verts[15].Set((640-609.0f) / PTM_RATIO, (360-353.0f) / PTM_RATIO);
