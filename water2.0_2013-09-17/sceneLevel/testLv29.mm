...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.9f,0.008f,80.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-594.0f) / PTM_RATIO, (360-8.0f) / PTM_RATIO);
    verts[1].Set((640-202.0f) / PTM_RATIO, (360-34.0f) / PTM_RATIO);
    verts[2].Set((640-189.0f) / PTM_RATIO, (360-206.0f) / PTM_RATIO);
    verts[3].Set((640-113.0f) / PTM_RATIO, (360-187.0f) / PTM_RATIO);
    verts[4].Set((640-103.0f) / PTM_RATIO, (360-158.0f) / PTM_RATIO);
    verts[5].Set((640-97.0f) / PTM_RATIO, (360-207.0f) / PTM_RATIO);
    verts[6].Set((640-181.0f) / PTM_RATIO, (360-244.0f) / PTM_RATIO);
    verts[7].Set((640-168.0f) / PTM_RATIO, (360-304.0f) / PTM_RATIO);
    verts[8].Set((640+128.0f) / PTM_RATIO, (360-303.0f) / PTM_RATIO);
    verts[9].Set((640+128.0f) / PTM_RATIO, (360-236.0f) / PTM_RATIO);
    verts[10].Set((640+36.0f) / PTM_RATIO, (360-213.0f) / PTM_RATIO);
    verts[11].Set((640+23.0f) / PTM_RATIO, (360-171.0f) / PTM_RATIO);
    verts[12].Set((640+44.0f) / PTM_RATIO, (360-186.0f) / PTM_RATIO);
    verts[13].Set((640+114.0f) / PTM_RATIO, (360-199.0f) / PTM_RATIO);
    verts[14].Set((640+125.0f) / PTM_RATIO, (360-41.0f) / PTM_RATIO);
    verts[15].Set((640+576.0f) / PTM_RATIO, (360-25.0f) / PTM_RATIO);
    verts[16].Set((640+598.0f) / PTM_RATIO, (360-354.0f) / PTM_RATIO);
    verts[17].Set((640-595.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
