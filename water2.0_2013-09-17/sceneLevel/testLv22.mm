...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-324.0f) / PTM_RATIO, (360+164.0f) / PTM_RATIO);
    verts[1].Set((640-337.0f) / PTM_RATIO, (360+45.0f) / PTM_RATIO);
    verts[2].Set((640-320.0f) / PTM_RATIO, (360-101.0f) / PTM_RATIO);
    verts[3].Set((640-272.0f) / PTM_RATIO, (360-169.0f) / PTM_RATIO);
    verts[4].Set((640-165.0f) / PTM_RATIO, (360-245.0f) / PTM_RATIO);
    verts[5].Set((640-54.0f) / PTM_RATIO, (360-285.0f) / PTM_RATIO);
    verts[6].Set((640+111.0f) / PTM_RATIO, (360-301.0f) / PTM_RATIO);
    verts[7].Set((640+276.0f) / PTM_RATIO, (360-278.0f) / PTM_RATIO);
    verts[8].Set((640+347.0f) / PTM_RATIO, (360-208.0f) / PTM_RATIO);
    verts[9].Set((640+366.0f) / PTM_RATIO, (360-56.0f) / PTM_RATIO);
    verts[10].Set((640+391.0f) / PTM_RATIO, (360+76.0f) / PTM_RATIO);
    verts[11].Set((640+372.0f) / PTM_RATIO, (360+169.0f) / PTM_RATIO);
    verts[12].Set((640+330.0f) / PTM_RATIO, (360+242.0f) / PTM_RATIO);
    verts[13].Set((640+246.0f) / PTM_RATIO, (360+317.0f) / PTM_RATIO);
    verts[14].Set((640+97.0f) / PTM_RATIO, (360+358.0f) / PTM_RATIO);
    verts[15].Set((640-137.0f) / PTM_RATIO, (360+346.0f) / PTM_RATIO);
    verts[16].Set((640-198.0f) / PTM_RATIO, (360+272.0f) / PTM_RATIO);
    verts[17].Set((640-248.0f) / PTM_RATIO, (360+170.0f) / PTM_RATIO);
    verts[18].Set((640-250.0f) / PTM_RATIO, (360+79.0f) / PTM_RATIO);
    verts[19].Set((640-203.0f) / PTM_RATIO, (360-64.0f) / PTM_RATIO);
    verts[20].Set((640-179.0f) / PTM_RATIO, (360-117.0f) / PTM_RATIO);
    verts[21].Set((640-135.0f) / PTM_RATIO, (360-158.0f) / PTM_RATIO);
    verts[22].Set((640-53.0f) / PTM_RATIO, (360-177.0f) / PTM_RATIO);
    verts[23].Set((640+72.0f) / PTM_RATIO, (360-177.0f) / PTM_RATIO);
    verts[24].Set((640+182.0f) / PTM_RATIO, (360-158.0f) / PTM_RATIO);
    verts[25].Set((640+259.0f) / PTM_RATIO, (360-111.0f) / PTM_RATIO);
    verts[26].Set((640+290.0f) / PTM_RATIO, (360+18.0f) / PTM_RATIO);
    verts[27].Set((640+254.0f) / PTM_RATIO, (360+125.0f) / PTM_RATIO);
    verts[28].Set((640+180.0f) / PTM_RATIO, (360+222.0f) / PTM_RATIO);
    verts[29].Set((640+68.0f) / PTM_RATIO, (360+255.0f) / PTM_RATIO);
    verts[30].Set((640-37.0f) / PTM_RATIO, (360+211.0f) / PTM_RATIO);
    verts[31].Set((640-113.0f) / PTM_RATIO, (360+117.0f) / PTM_RATIO);
    verts[32].Set((640-117.0f) / PTM_RATIO, (360+36.0f) / PTM_RATIO);
    verts[33].Set((640-95.0f) / PTM_RATIO, (360-35.0f) / PTM_RATIO);
    verts[34].Set((640-3.0f) / PTM_RATIO, (360-72.0f) / PTM_RATIO);
    verts[35].Set((640+93.0f) / PTM_RATIO, (360-83.0f) / PTM_RATIO);
    verts[36].Set((640+148.0f) / PTM_RATIO, (360-70.0f) / PTM_RATIO);
    verts[37].Set((640+165.0f) / PTM_RATIO, (360-45.0f) / PTM_RATIO);
    verts[38].Set((640+173.0f) / PTM_RATIO, (360-29.0f) / PTM_RATIO);
    
    verts[39].Set((640+164.0f) / PTM_RATIO, (360-24.0f) / PTM_RATIO);
    verts[40].Set((640+134.0f) / PTM_RATIO, (360-56.0f) / PTM_RATIO);
    verts[41].Set((640+79.0f) / PTM_RATIO, (360-62.0f) / PTM_RATIO);
    verts[42].Set((640-13.0f) / PTM_RATIO, (360-50.0f) / PTM_RATIO);
    verts[43].Set((640-63.0f) / PTM_RATIO, (360-13.0f) / PTM_RATIO);
    verts[44].Set((640-83.0f) / PTM_RATIO, (360+42.0f) / PTM_RATIO);
    verts[45].Set((640-77.0f) / PTM_RATIO, (360+95.0f) / PTM_RATIO);
    verts[46].Set((640-53.0f) / PTM_RATIO, (360+143.0f) / PTM_RATIO);
    verts[47].Set((640+48.0f) / PTM_RATIO, (360+204.0f) / PTM_RATIO);
    verts[48].Set((640+124.0f) / PTM_RATIO, (360+208.0f) / PTM_RATIO);
    verts[49].Set((640+205.0f) / PTM_RATIO, (360+167.0f) / PTM_RATIO);
    verts[50].Set((640+236.0f) / PTM_RATIO, (360+97.0f) / PTM_RATIO);
    verts[51].Set((640+256.0f) / PTM_RATIO, (360+4.0f) / PTM_RATIO);
    verts[52].Set((640+253.0f) / PTM_RATIO, (360-63.0f) / PTM_RATIO);
    verts[53].Set((640+193.0f) / PTM_RATIO, (360-129.0f) / PTM_RATIO);
    verts[54].Set((640+109.0f) / PTM_RATIO, (360-150.0f) / PTM_RATIO);
    verts[55].Set((640-36.0f) / PTM_RATIO, (360-153.0f) / PTM_RATIO);
    verts[56].Set((640-87.0f) / PTM_RATIO, (360-122.0f) / PTM_RATIO);
    verts[57].Set((640-130.0f) / PTM_RATIO, (360-35.0f) / PTM_RATIO);
    verts[58].Set((640-147.0f) / PTM_RATIO, (360+50.0f) / PTM_RATIO);
    verts[59].Set((640-162.0f) / PTM_RATIO, (360+145.0f) / PTM_RATIO);
    verts[60].Set((640-116.0f) / PTM_RATIO, (360+212.0f) / PTM_RATIO);
    verts[61].Set((640+22.0f) / PTM_RATIO, (360+258.0f) / PTM_RATIO);
    verts[62].Set((640+127.0f) / PTM_RATIO, (360+279.0f) / PTM_RATIO);
    verts[63].Set((640+213.0f) / PTM_RATIO, (360+248.0f) / PTM_RATIO);
    verts[64].Set((640+261.0f) / PTM_RATIO, (360+147.0f) / PTM_RATIO);
    verts[65].Set((640+282.0f) / PTM_RATIO, (360+99.0f) / PTM_RATIO);
    verts[66].Set((640+302.0f) / PTM_RATIO, (360+46.0f) / PTM_RATIO);
    verts[67].Set((640+321.0f) / PTM_RATIO, (360-21.0f) / PTM_RATIO);
    verts[68].Set((640+308.0f) / PTM_RATIO, (360-91.0f) / PTM_RATIO);
    verts[69].Set((640+149.0f) / PTM_RATIO, (360-192.0f) / PTM_RATIO);
    verts[70].Set((640-10.0f) / PTM_RATIO, (360-223.0f) / PTM_RATIO);
    verts[71].Set((640-82.0f) / PTM_RATIO, (360-221.0f) / PTM_RATIO);
    verts[72].Set((640-203.0f) / PTM_RATIO, (360-140.0f) / PTM_RATIO);
    verts[73].Set((640-220.0f) / PTM_RATIO, (360-91.0f) / PTM_RATIO);
    verts[74].Set((640-283.0f) / PTM_RATIO, (360+120.0f) / PTM_RATIO);
    verts[75].Set((640-297.0f) / PTM_RATIO, (360+157.0f) / PTM_RATIO);
