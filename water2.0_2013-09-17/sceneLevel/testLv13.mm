...
//    [self addSingleMap];
    ...
    bodyDef.position.Set((840-0.0f) / PTM_RATIO, (310+275.0f) / PTM_RATIO);
    bodyDef.angle = 0.f;
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-635.7f) / PTM_RATIO, (360+100.9f) / PTM_RATIO);
    verts[1].Set((640-601.7f) / PTM_RATIO, (360+100.6f) / PTM_RATIO);
    verts[2].Set((640-580.5f) / PTM_RATIO, (360-101.1f) / PTM_RATIO);
    verts[3].Set((640-276.5f) / PTM_RATIO, (360-101.1f) / PTM_RATIO);
    verts[4].Set((640-224.2f) / PTM_RATIO, (360+100.4f) / PTM_RATIO);
    verts[5].Set((640+624.4f) / PTM_RATIO, (360+100.4f) / PTM_RATIO);
    verts[6].Set((640+625.8f) / PTM_RATIO, (360-347.2f) / PTM_RATIO);
    verts[7].Set((640-634.3f) / PTM_RATIO, (360-344.4f) / PTM_RATIO);
