...
-(void)createRev
{
    ...
    bodyDef.position.Set((840+320)/PTM_RATIO, (180+60)/PTM_RATIO);
    bodyDef.angle = 0.f;
    ...
    bodyDef2.position.Set((640+260)/PTM_RATIO, (360+70)/PTM_RATIO);
    bodyDef2.angle = 0.f;
    b2Body *body2 = m_world->CreateBody(&bodyDef2);
    // Define another box shape for our dynamic body.
    b2PolygonShape dynamicBox2;
    dynamicBox2.SetAsBox(8.15f,0.35f);
    // Define the dynamic body fixture.
    ...
    revoluteJointDef.localAnchorB.Set(8.0,0);
    revoluteJointDef.motorSpeed = 0;
    revoluteJointDef.maxMotorTorque = PI/6.f;
    revoluteJointDef.enableMotor = false;
    revoluteJointDef.referenceAngle = PI/6.f;
    revoluteJointDef.enableLimit = true;
    revoluteJointDef.lowerAngle = -10 ;
    revoluteJointDef.upperAngle =  10;
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-580.5f) / PTM_RATIO, (360+-3.5f) / PTM_RATIO);
    verts[1].Set((640-427.8f) / PTM_RATIO, (360+46.0f) / PTM_RATIO);
    verts[2].Set((640-330.2f) / PTM_RATIO, (360+34.6f) / PTM_RATIO);
    verts[3].Set((640-263.8f) / PTM_RATIO, (360+33.2f) / PTM_RATIO);
    verts[4].Set((640-181.7f) / PTM_RATIO, (360+-140.7f) / PTM_RATIO);
    verts[5].Set((640-174.7f) / PTM_RATIO, (360+-350.0f) / PTM_RATIO);
    verts[6].Set((640-576.3f) / PTM_RATIO, (360+-352.8f) / PTM_RATIO);
...
-(void)addMap2
{
    ...
    verts2[0].Set((640.f+48.8f) / PTM_RATIO, (360.f+61.5f) / PTM_RATIO);
    verts2[1].Set((640.f+108.2f) / PTM_RATIO, (360.f+65.8f) / PTM_RATIO);
    verts2[2].Set((640.f+111.0f) / PTM_RATIO, (360.f-195.9f) / PTM_RATIO);
    verts2[3].Set((640.f+194.5f) / PTM_RATIO, (360.f-270.8f) / PTM_RATIO);
    verts2[4].Set((640.f+395.3f) / PTM_RATIO, (360.f-260.9f) / PTM_RATIO);
    verts2[5].Set((640.f+463.2f) / PTM_RATIO, (360.f-123.7f) / PTM_RATIO);
    verts2[6].Set((640.f+630.0f) / PTM_RATIO, (360.f-135.1f) / PTM_RATIO);
    verts2[7].Set((640.f+572.0f) / PTM_RATIO, (360.f-348.6f) / PTM_RATIO);
    verts2[8].Set((640.f+36.1f) / PTM_RATIO, (360.f-347.2f) / PTM_RATIO);
    ...
    shape.m_hasVertex0 = true;
    shape.m_vertex0 = verts2[vertsNum2-2];
    ground->CreateFixture(&shape, 0.0f);
