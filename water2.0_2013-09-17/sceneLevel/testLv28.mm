...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(1.0f,0.008f,30.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    bodyDef2.position.Set((shushuiPs.x-300)/PTM_RATIO, (shushuiPs.y-140.f)/PTM_RATIO);
//    bodyDef2.angle = -5*PI/180;
//    b2Body *body2 = m_world->CreateBody(&bodyDef2);
//    // Define another box shape for our dynamic body.
//    b2PolygonShape dynamicBox2;
//    dynamicBox2.SetAsBox(8.f,0.65f);
...
//    bodyDef3.position.Set((shushuiPs.x+10.f)/PTM_RATIO, (shushuiPs.y+100.f)/PTM_RATIO);
//    bodyDef3.angle = 0;
//    b2Body *body3 = m_world->CreateBody(&bodyDef3);
//    // Define another box shape for our dynamic body.
//    b2PolygonShape dynamicBox3;
//    dynamicBox3.SetAsBox(0.65f,8.5f);
//    // Define the dynamic body fixture.
...
//    bodyDef4.position.Set((shushuiPs.x-340.f)/PTM_RATIO, (shushuiPs.y+100.f)/PTM_RATIO);
//    bodyDef4.angle = 0;
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-556.0f) / PTM_RATIO, (360+269.0f) / PTM_RATIO);
    verts[1].Set((640-542.0f) / PTM_RATIO, (360-345.0f) / PTM_RATIO);
    verts[2].Set((640+613.0f) / PTM_RATIO, (360-349.0f) / PTM_RATIO);
    verts[3].Set((640+588.0f) / PTM_RATIO, (360-65.0f) / PTM_RATIO);
    verts[4].Set((640+218.0f) / PTM_RATIO, (360-68.0f) / PTM_RATIO);
    verts[5].Set((640-265.0f) / PTM_RATIO, (360+257.0f) / PTM_RATIO);
    verts[6].Set((640-267.0f) / PTM_RATIO, (360+287.0f) / PTM_RATIO);
    verts[7].Set((640-323.0f) / PTM_RATIO, (360+281.0f) / PTM_RATIO);
    verts[8].Set((640-306.0f) / PTM_RATIO, (360+224.0f) / PTM_RATIO);
    verts[9].Set((640+84.0f) / PTM_RATIO, (360-93.0f) / PTM_RATIO);
    verts[10].Set((640+104.0f) / PTM_RATIO, (360-273.0f) / PTM_RATIO);
    verts[11].Set((640-383.0f) / PTM_RATIO, (360-247.0f) / PTM_RATIO);
    verts[12].Set((640-354.0f) / PTM_RATIO, (360-117.0f) / PTM_RATIO);
    verts[13].Set((640-359.0f) / PTM_RATIO, (360+21.0f) / PTM_RATIO);
    verts[14].Set((640-399.0f) / PTM_RATIO, (360+137.0f) / PTM_RATIO);
    verts[15].Set((640-415.0f) / PTM_RATIO, (360+321.0f) / PTM_RATIO);
    verts[16].Set((640-553.0f) / PTM_RATIO, (360+319.0f) / PTM_RATIO);
