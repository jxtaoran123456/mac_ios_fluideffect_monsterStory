...
-(void)addMap
{
    ...
    verts[0].Set((640-24.0f) / PTM_RATIO, (360-74.0f) / PTM_RATIO);
    verts[1].Set((640-296.0f) / PTM_RATIO, (360-76.0f) / PTM_RATIO);
    verts[2].Set((640-300.0f) / PTM_RATIO, (360-151.0f) / PTM_RATIO);
    verts[3].Set((640-360.0f) / PTM_RATIO, (360-159.0f) / PTM_RATIO);
    verts[4].Set((640-367.0f) / PTM_RATIO, (360-224.0f) / PTM_RATIO);
    verts[5].Set((640-437.0f) / PTM_RATIO, (360-241.0f) / PTM_RATIO);
    verts[6].Set((640-449.0f) / PTM_RATIO, (360-308.0f) / PTM_RATIO);
    verts[7].Set((640-635.0f) / PTM_RATIO, (360-317.0f) / PTM_RATIO);
    verts[8].Set((640-636.0f) / PTM_RATIO, (360-352.0f) / PTM_RATIO);
    verts[9].Set((640+634.0f) / PTM_RATIO, (360-353.0f) / PTM_RATIO);
    verts[10].Set((640+624.0f) / PTM_RATIO,(360+ 343.0f) / PTM_RATIO);
    verts[11].Set((640-630.0f) / PTM_RATIO,(360+ 354.0f) / PTM_RATIO);
    verts[12].Set((640-633.0f) / PTM_RATIO,(360+ 129.0f) / PTM_RATIO);
    verts[13].Set((640-20.0f) / PTM_RATIO,(360+ 122.0f) / PTM_RATIO);
