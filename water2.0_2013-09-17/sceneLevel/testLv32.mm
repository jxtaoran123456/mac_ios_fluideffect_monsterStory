...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.9f,0.006f,100.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
    ...
    b2BodyDef bodyDef;
//    b2Vec2 verts[] = {
//        b2Vec2(-26.0f / PTM_RATIO, 134.0f / PTM_RATIO),
//        b2Vec2(-24.0f / PTM_RATIO, 22.0f / PTM_RATIO),
//        b2Vec2(17.0f / PTM_RATIO, -27.0f / PTM_RATIO),
//        b2Vec2(49.0f / PTM_RATIO, -33.0f / PTM_RATIO),
//        b2Vec2(36.0f / PTM_RATIO, -10.0f / PTM_RATIO),
//        b2Vec2(12.0f / PTM_RATIO, 20.0f / PTM_RATIO),
//        b2Vec2(6.0f / PTM_RATIO, 65.0f / PTM_RATIO),
//        b2Vec2(10.0f / PTM_RATIO, 152.0f / PTM_RATIO)
//    };
    b2Vec2 verts[] = {
        b2Vec2(-46.0f / PTM_RATIO, 89.0f / PTM_RATIO),
        b2Vec2(-39.0f / PTM_RATIO, 11.0f / PTM_RATIO),
        b2Vec2(-27.0f / PTM_RATIO, -27.0f / PTM_RATIO),
        b2Vec2(17.0f / PTM_RATIO, -83.0f / PTM_RATIO),
        b2Vec2(49.0f / PTM_RATIO, -95.0f / PTM_RATIO),
        b2Vec2(17.0f / PTM_RATIO, -19.0f / PTM_RATIO),
        b2Vec2(0.0f / PTM_RATIO, 16.0f / PTM_RATIO),
        b2Vec2(-1.0f / PTM_RATIO, 110.0f / PTM_RATIO)
    };
    
    bodyDef.angle = 0.f*PI/180.f;
    bodyDef.type = b2_staticBody;
    bodyDef.position.Set(720.f/PTM_RATIO, 380.f/PTM_RATIO);
    b2Body *body = m_world->CreateBody(&bodyDef);
    // Define another box shape for our dynamic body.
    b2PolygonShape dynamicBox;
    dynamicBox.Set(verts, 8);
    ...
    bodyDef2.position.Set(420.f/PTM_RATIO, 180.f/PTM_RATIO);
    bodyDef2.angle = 10.f*PI/180.f;
    b2Body *body2 = m_world->CreateBody(&bodyDef2);
    // Define another box shape for our dynamic body.
    b2PolygonShape dynamicBox2;
    dynamicBox2.SetAsBox(0.25f,0.55f);
    // Define the dynamic body fixture.
...
{
    if(body->toolsType == 1014 && gedang != NULL && gedang->GetPosition().y > 320.f/PTM_RATIO)
    {
        gedang->SetTransform(b2Vec2(gedang->GetPosition().x,gedang->GetPosition().y-0.003f), gedang->GetAngle());
    }
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640+341.0f+200) / PTM_RATIO, (360+343.0f) / PTM_RATIO);
    verts[1].Set((640+136.0f+200) / PTM_RATIO, (360+343.0f) / PTM_RATIO);
    verts[2].Set((640+23.0f+200) / PTM_RATIO, (360+298.0f) / PTM_RATIO);
    verts[3].Set((640-141.0f+200) / PTM_RATIO, (360+202.0f) / PTM_RATIO);
    verts[4].Set((640-222.0f+200) / PTM_RATIO, (360+92.0f) / PTM_RATIO);
    verts[5].Set((640-199.0f+200) / PTM_RATIO, (360-6.0f) / PTM_RATIO);
    verts[6].Set((640-64.0f+200) / PTM_RATIO, (360+118.0f) / PTM_RATIO);
    verts[7].Set((640+87.0f+200) / PTM_RATIO, (360+84.0f) / PTM_RATIO);
    verts[8].Set((640-8.0f+200) / PTM_RATIO, (360+44.0f) / PTM_RATIO);
    verts[9].Set((640+46.0f+200) / PTM_RATIO, (360-14.0f) / PTM_RATIO);
    verts[10].Set((640+6.0f+200) / PTM_RATIO, (360-95.0f) / PTM_RATIO);
    verts[11].Set((640+241.0f+200) / PTM_RATIO, (360-75.0f) / PTM_RATIO);
    verts[12].Set((640+244.0f+200) / PTM_RATIO, (360-246.0f) / PTM_RATIO);
    verts[13].Set((640+64.0f+200) / PTM_RATIO, (360-313.0f) / PTM_RATIO);
    verts[14].Set((640-69.0f+200) / PTM_RATIO, (360-251.0f) / PTM_RATIO);
    verts[15].Set((640-102.0f+200) / PTM_RATIO, (360-142.0f) / PTM_RATIO);
    verts[16].Set((640-65.0f+200) / PTM_RATIO, (360-114.0f) / PTM_RATIO);
    verts[17].Set((640-37.0f+200) / PTM_RATIO, (360-101.0f) / PTM_RATIO);
    verts[18].Set((640-81.0f+200) / PTM_RATIO, (360-100.0f) / PTM_RATIO);
    verts[19].Set((640-152.0f+200) / PTM_RATIO, (360-180.0f) / PTM_RATIO);
    verts[20].Set((640-148.0f+200) / PTM_RATIO, (360-277.0f) / PTM_RATIO);
    verts[21].Set((640-60.0f+200) / PTM_RATIO, (360-337.0f) / PTM_RATIO);
    verts[22].Set((640+326.0f+200) / PTM_RATIO, (360-337.0f) / PTM_RATIO);
    verts[23].Set((640+464.0f+200) / PTM_RATIO, (360-210.0f) / PTM_RATIO);
...
-(void)addMap1
{
    ...
    verts1[0].Set((640-368.0f) / PTM_RATIO, (360+48.0f) / PTM_RATIO);
    verts1[1].Set((640-325.0f) / PTM_RATIO, (360+124.0f) / PTM_RATIO);
    verts1[2].Set((640-161.0f) / PTM_RATIO, (360+35.0f) / PTM_RATIO);
    verts1[3].Set((640-185.0f) / PTM_RATIO, (360-71.0f) / PTM_RATIO);
    verts1[4].Set((640-368.0f) / PTM_RATIO, (360-140.0f) / PTM_RATIO);
    verts1[5].Set((640-321.0f) / PTM_RATIO, (360-210.0f) / PTM_RATIO);
    verts1[6].Set((640-148.0f) / PTM_RATIO, (360-177.0f) / PTM_RATIO);
    verts1[7].Set((640-319.0f) / PTM_RATIO, (360-279.0f) / PTM_RATIO);
    verts1[8].Set((640-528.0f) / PTM_RATIO, (360-222.0f) / PTM_RATIO);
    verts1[9].Set((640-543.0f) / PTM_RATIO, (360-314.0f) / PTM_RATIO);
    verts1[10].Set((640-611.0f) / PTM_RATIO, (360-351.0f) / PTM_RATIO);
    verts1[11].Set((640-611.0f) / PTM_RATIO, (360+103.0f) / PTM_RATIO);
