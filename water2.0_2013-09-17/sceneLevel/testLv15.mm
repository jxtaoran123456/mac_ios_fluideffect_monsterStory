...
-(void)createStaticGeometry
{
    ...
    // Particles
    initFluidPraticles(0.8f,0.005f,60.f,30.f,2000,@"fire_010.png",nil);// VbmyR.png fire2 drop2
...
//    body->CreateFixture(&fixtureDef);
    ...
    bodyDef3.position.Set((shushuiPs.x-255.f)/PTM_RATIO, (shushuiPs.y+140.f)/PTM_RATIO);//255.f
    bodyDef3.angle = -1*60.f*PI/180.f;
    ...
    bodyDef4.position.Set((shushuiPs.x+65.f)/PTM_RATIO, (shushuiPs.y+140.f)/PTM_RATIO);//75.f
    bodyDef4.angle = 60.f*PI/180.f;;
    b2Body *body4 = m_world->CreateBody(&bodyDef4);
    // Define another box shape for our dynamic body.
    b2PolygonShape dynamicBox4;
    dynamicBox4.SetAsBox(8.f,0.65f);
    // Define the dynamic body fixture.
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640-561.0f) / PTM_RATIO, (360+301.0f) / PTM_RATIO);
    verts[1].Set((640-591.0f) / PTM_RATIO, (360+185.0f) / PTM_RATIO);
    verts[2].Set((640-611.0f) / PTM_RATIO, (360+63.0f) / PTM_RATIO);
    verts[3].Set((640-601.0f) / PTM_RATIO, (360-21.0f) / PTM_RATIO);
    verts[4].Set((640-583.0f) / PTM_RATIO, (360-163.0f) / PTM_RATIO);
    verts[5].Set((640-532.0f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
    verts[6].Set((640+615.0f) / PTM_RATIO, (360-354.0f) / PTM_RATIO);
    verts[7].Set((640+626.0f) / PTM_RATIO, (360+134.0f) / PTM_RATIO);
    verts[8].Set((640+460.0f) / PTM_RATIO, (360+139.0f) / PTM_RATIO);
    verts[9].Set((640+429.0f) / PTM_RATIO, (360-68.0f) / PTM_RATIO);
    verts[10].Set((640+234.0f) / PTM_RATIO, (360-68.0f) / PTM_RATIO);
    verts[11].Set((640+156.0f) / PTM_RATIO, (360+166.0f) / PTM_RATIO);
    verts[12].Set((640-61.0f) / PTM_RATIO, (360+166.0f) / PTM_RATIO);
    verts[13].Set((640-199.0f) / PTM_RATIO, (360-93.0f) / PTM_RATIO);
    verts[14].Set((640-372.0f) / PTM_RATIO, (360-82.0f) / PTM_RATIO);
    verts[15].Set((640-441.0f) / PTM_RATIO, (360-26.0f) / PTM_RATIO);
    verts[16].Set((640-514.0f) / PTM_RATIO, (360+171.0f) / PTM_RATIO);
