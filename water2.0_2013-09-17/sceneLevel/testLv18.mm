...
//	b2GearJoint* m_joint5;
    {
		...
		// Gears co
		{
			...
			bd1.position.Set(20.0f, 16.0f);
			b2Body* body1 = m_world->CreateBody(&bd1);
			body1->CreateFixture(&circle1, 0.0f);
            
			b2BodyDef bd2;
			bd2.type = b2_dynamicBody;
			bd2.position.Set(20.0f, 14.0f);
			b2Body* body2 = m_world->CreateBody(&bd2);
			body2->CreateFixture(&box, 11.0f);
            
			b2BodyDef bd3;
			bd3.type = b2_dynamicBody;
			bd3.position.Set(20.0f, 12.0f);
			b2Body* body3 = m_world->CreateBody(&bd3);
			body3->CreateFixture(&circle2, 11.0f);
...
//			b2BodyDef bd3;
//			bd3.type = b2_dynamicBody;
//			bd3.position.Set(12.5f, 12.0f);
//			b2Body* body3 = m_world->CreateBody(&bd3);
//			body3->CreateFixture(&box, 5.0f);
//            
//			b2PrismaticJointDef jd3;
//			jd3.Initialize(ground, body3, bd3.position, b2Vec2(0.0f, 1.0f));
//			jd3.lowerTranslation = -15.0f;
//			jd3.upperTranslation = 15.0f;
...
//    verts[10].Set((640-630.0f) / PTM_RATIO, (360-355.0f) / PTM_RATIO);
    ...
    verts[0].Set((640+562.0f) / PTM_RATIO, (360+356.0f) / PTM_RATIO);
    verts[1].Set((640+353.0f) / PTM_RATIO, (360+351.0f) / PTM_RATIO);
    verts[2].Set((640+271.0f) / PTM_RATIO, (360+315.0f) / PTM_RATIO);
    verts[3].Set((640+288.0f) / PTM_RATIO, (360+167.0f) / PTM_RATIO);
    verts[4].Set((640+391.0f) / PTM_RATIO, (360+150.0f) / PTM_RATIO);
    verts[5].Set((640+604.0f) / PTM_RATIO, (360+80.0f) / PTM_RATIO);
    verts[6].Set((640+537.0f) / PTM_RATIO, (360+26.0f) / PTM_RATIO);
    verts[7].Set((640+311.0f) / PTM_RATIO, (360-48.0f) / PTM_RATIO);
    verts[8].Set((640+319.0f) / PTM_RATIO, (360-113.0f) / PTM_RATIO);
    verts[9].Set((640+586.0f) / PTM_RATIO, (360-144.0f) / PTM_RATIO);
    verts[10].Set((640+628.0f) / PTM_RATIO, (360-281.0f) / PTM_RATIO);
    verts[11].Set((640+355.0f) / PTM_RATIO, (360-309.0f) / PTM_RATIO);
    verts[12].Set((640+330.0f) / PTM_RATIO, (360-207.0f) / PTM_RATIO);
    verts[13].Set((640+302.0f) / PTM_RATIO, (360-348.0f) / PTM_RATIO);
    verts[14].Set((640+632.0f) / PTM_RATIO, (360-356.0f) / PTM_RATIO);
    verts[15].Set((640+632.0f) / PTM_RATIO, (360+343.0f) / PTM_RATIO);
